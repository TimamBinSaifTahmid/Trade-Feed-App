        ...
        firepro4.on('value', function (snapshot4) {
          ...
          for (var i = 1; i <= childcnt1; i++) {
            ...
            if (sname == scid) {
              ...
              var ratingProvider = snapshot3.child(sid).val().Rate;
              ratingProvider=ratingProvider.toFixed(3);
              document.getElementById('rate').innerHTML = ratingProvider;
            }
          }
        });
      });
